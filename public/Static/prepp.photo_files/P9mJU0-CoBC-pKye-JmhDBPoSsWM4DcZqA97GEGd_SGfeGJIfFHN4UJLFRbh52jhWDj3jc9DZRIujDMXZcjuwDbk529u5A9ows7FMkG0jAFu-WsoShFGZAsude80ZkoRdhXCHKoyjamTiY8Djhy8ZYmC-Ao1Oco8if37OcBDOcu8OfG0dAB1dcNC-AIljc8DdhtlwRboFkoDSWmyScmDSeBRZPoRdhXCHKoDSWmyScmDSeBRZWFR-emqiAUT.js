...
window.Typekit.config = {
  a: '646866',
  dl: 'AAABAwAAAApro2p7FG3Yp0Lp1aeKp_bAn1quISvWUBGQuyp4jto3NAAAAAQ',
  fi: [14032, 14038, 14034, 14033, 14035],
  fc: [
    {
      id: 14032,
      family: 'aktiv-grotesk',
      src: 'https://use.typekit.net/af/ab3e12/000000000000000077359d4f/30/{format}{?primer,subset_id,fvd,v}',
      descriptors: { weight: '400', style: 'normal', display: 'auto', subset_id: 2 },
    },
    {
      id: 14038,
      family: 'aktiv-grotesk',
      src: 'https://use.typekit.net/af/c11a71/000000000000000077359d5e/30/{format}{?primer,subset_id,fvd,v}',
      descriptors: { weight: '500', style: 'normal', display: 'auto', subset_id: 2 },
    },
    {
      id: 14034,
      family: 'aktiv-grotesk',
      src: 'https://use.typekit.net/af/a798a9/000000000000000077359d55/30/{format}{?primer,subset_id,fvd,v}',
      descriptors: { weight: '700', style: 'normal', display: 'auto', subset_id: 2 },
    },
    {
      id: 14033,
      family: 'aktiv-grotesk',
      src: 'https://use.typekit.net/af/951aca/000000000000000077359d51/30/{format}{?primer,subset_id,fvd,v}',
      descriptors: { weight: '400', style: 'italic', display: 'auto', subset_id: 2 },
    },
    {
      id: 14035,
      family: 'aktiv-grotesk',
      src: 'https://use.typekit.net/af/8e3d9f/000000000000000077359d58/30/{format}{?primer,subset_id,fvd,v}',
      descriptors: { weight: '700', style: 'italic', display: 'auto', subset_id: 2 },
    },
  ],
  ...
  ht: 'tk',
  js: '1.20.0',
  kt: '646866_60be3f15c04ff53428559e91',
  l: 'typekit',
  ps: 2,
...
/*{"k":"1.20.0","auto_updating":true,"last_published":"2021-06-07 15:45:51 UTC"}*/
;(function (window, document, undefined) {
  ...
  var ha = [
    2449897292, 4218179547, 2675077685, 1031960064, 1478620578, 1386343184, 3194259988, 2656050674,
    3012733295, 2193273665,
  ]
  ...
  function F(a, b) {
    return new ma(b, a.g, { weight: a.weight, style: a.style, B: a.B, C: a.C, display: a.display })
  }
  function D(a) {
      ...
      d = new Promise(function (d, e) {
        function k() {
          l() - c >= b.g
            ? e()
            : a.fonts
                .load(b.b.style + ' ' + b.b.weight + ' 300px ' + (b.j ? E(b.b) : b.b.b), b.o)
                .then(
                  function (a) {
      ...
      active: function () {
        ...
        if (d.m) {
          var a = d.m,
            ...
            w = []
          window.Typekit
            ? (window.Typekit.fonts || (window.Typekit.fonts = []), (w = window.Typekit.fonts))
            : window.TypekitPreview &&
              (window.TypekitPreview.fonts || (window.TypekitPreview.fonts = []),
