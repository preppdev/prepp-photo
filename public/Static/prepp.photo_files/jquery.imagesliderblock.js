/*
Copyright 2021 Rebecca Grace Designs
All rights Reserved
Description: Before After Image Slider for Squarespace 7.1
*/
...
;(function ($) {
  $.fn.imagesliderblock = function (options) {
    ...
    return this.each(function () {
      ...
      container.wrap(
        "<div class='rebeccagrace-wrapper rebeccagrace-" + sliderOrientation + "'></div>"
      )
      if (!options.no_overlay) {
        ...
        overlay.append(
          "<div class='rebeccagrace-after-label' data-content='" + options.after_label + "'></div>"
        )
      }
